...
public class RegularGeneratorTest {
    private Template template = new RegularGenerator();
    ...
    @Test
    public void whenUsingSpecificBoundariesThenFindsAndReplacesKeys() {
        template = new RegularGenerator("[[", "]]");
        String templateText = "these are [[key]] and [[key]]";
        String result = template.generate(templateText, Map.of("key", "doubles"));
        assertThat(result, is("these are doubles and doubles"));
    }
}
